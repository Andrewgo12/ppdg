...
interface DirectorProgramaPanelProps {
  subRoleInfo: SubRoleInfo
  onOpenReasignacionModal: () => void
}

export function DirectorProgramaPanel({
  subRoleInfo,
  onOpenReasignacionModal,
}: DirectorProgramaPanelProps) {
  return (
    <div className="rounded-sm border border-border/60 bg-card p-3 space-y-2.5 shadow-sm">
      ...
      <div className="flex flex-wrap gap-2 pt-1">
        ...
        >
          ...
          Reasignación Masiva de Clases por Contingencia
        </Button>
      </div>

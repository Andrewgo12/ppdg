    ...
    <div className="rounded-sm border border-border/60 bg-card p-3 space-y-2.5 shadow-sm">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border/60 pb-3">
        <div className="flex items-center gap-2.5">
          <div className="flex size-6 items-center justify-center rounded-sm bg-zinc-700/10 text-zinc-800 dark:text-zinc-200">
        ...
        <span className="rounded-sm bg-zinc-700/10 px-3 py-1 text-[10px] font-semibold text-zinc-800 dark:text-zinc-200">
          {subRoleInfo.badge}
        </span>
      </div>

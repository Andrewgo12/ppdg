...
export function EmergenciaElectricaModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 bg-foreground/40 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-md rounded-sm border border-amber-500/50 bg-card p-3 shadow-2xl space-y-2.5 text-center">
        <button
          onClick={onClose}
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            className="w-1/2 rounded-sm text-xs font-bold gap-1"
          >

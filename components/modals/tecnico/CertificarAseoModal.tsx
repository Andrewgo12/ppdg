...
export function CertificarAseoModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 bg-foreground/40 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-md rounded-sm border border-emerald-500/30 bg-card p-3 shadow-2xl space-y-2.5 text-center">
        <button
          onClick={onClose}
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            className="w-1/2 rounded-sm text-xs font-bold bg-zinc-800 hover:bg-emerald-700 text-white gap-1.5"
          >
